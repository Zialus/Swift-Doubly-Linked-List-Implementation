...
final class QueueTests: XCTestCase {
    ...
    func testAdvancedQueue2() {
        ...
        XCTAssertEqual(myq2.list.indexOf(7), 2)  // SOMEWHERE MIDDLE
        ...
        XCTAssertEqual(myq2.list.removeLast(), 11) // REMOVES AND RETURNS
        XCTAssertEqual(myq2.list.removeLast(), 77) // REMOVES AND RETURNS
        XCTAssertEqual(myq2.list.removeLast(), 9) // REMOVES AND RETURNS
        XCTAssertEqual(myq2.list.removeLast(), 99) // REMOVES AND RETURNS
        XCTAssertEqual(myq2.list.removeLast(), 7) // REMOVES AND RETURNS
        XCTAssertEqual(myq2.list.removeLast(), 5) // REMOVES AND RETURNS
        XCTAssertEqual(myq2.list.removeLast(), 88) // REMOVES AND RETURNS
